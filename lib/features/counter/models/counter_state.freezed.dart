...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CounterState&&(identical(other.inc, inc) || other.inc == inc)&&(identical(other.dec, dec) || other.dec == dec));
}


@override
int get hashCode => Object.hash(runtimeType,inc,dec);

@override
String toString() {
  return 'CounterState(inc: $inc, dec: $dec)';
}
...
/// Create a copy of CounterState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? inc = null,Object? dec = null,}) {
  return _then(_self.copyWith(
inc: null == inc ? _self.inc : inc // ignore: cast_nullable_to_non_nullable
as int,dec: null == dec ? _self.dec : dec // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int inc,  int dec)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CounterState() when $default != null:
return $default(_that.inc,_that.dec);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int inc,  int dec)  $default,) {final _that = this;
switch (_that) {
case _CounterState():
return $default(_that.inc,_that.dec);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int inc,  int dec)?  $default,) {final _that = this;
switch (_that) {
case _CounterState() when $default != null:
return $default(_that.inc,_that.dec);case _:
  return null;
...
class _CounterState implements CounterState {
  const _CounterState({required this.inc, required this.dec});
  

@override final  int inc;
@override final  int dec;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CounterState&&(identical(other.inc, inc) || other.inc == inc)&&(identical(other.dec, dec) || other.dec == dec));
}
...
/// Create a copy of CounterState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? inc = null,Object? dec = null,}) {
